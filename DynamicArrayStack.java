...
public DynamicArrayStack() { stack = new ArrayList<>();
}
...
System.out.println("Stack elements (top to bottom):"); for (int i = stack.size() - 1; i >= 0; i--) {
...
System.out.println("Pop: " + stack.pop()); // Expected: 30 stack.print(); // Expected: 20 10
System.out.println("Pop: " + stack.pop()); // Expected: 20 stack.print(); // Expected: 10
// Testing stack underflow
System.out.println("Pop: " + stack.pop()); // Expected: 10 stack.print(); // Expected: Stack is empty
