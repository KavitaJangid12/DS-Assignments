...
try {
arrOps.insert(10); arrOps.insert(20); arrOps.insert(30);
arrOps.print(); // Expected: 10 20 30
arrOps.insertAt(1, 15);
arrOps.print(); // Expected: 10 15 20 30
arrOps.remove(20);
arrOps.print(); // Expected: 10 15 30
arrOps.removeAt(0); arrOps.print(); // Expected: 15 30
// Edge cases
arrOps.insertAt(1, 25); arrOps.print(); // Expected: 15 25 30

arrOps.removeAt(1); arrOps.print(); // Expected: 15 30
arrOps.insert(40);
arrOps.insert(50);
